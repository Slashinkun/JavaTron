...
import static globalPack.globalVar.roomWidth;import static globalPack.globalVar.roomHeight;
    ...
    private Canvas()
    {
        ...
        if (System.getProperty("com.horstmann.codecheck") == null)
        {
            frame = new JFrame();
                ...
                frame.add(component);
                frame.pack();
                frame.setSize(roomWidth,roomHeight); // set the size of the window
                frame.setResizable(false); //if window can be resizable
